...
public record Source(String documentId, SourceType type, String link, String pageNumber, String subsection, String version) {
    public Source(SourceType type, String link) {
        this(null, type, link, null, null, null);
    }
