...
public enum ChatStatus {
    ...
    II_PRICES("Récupération des informations des tarifs : %s", "Abrufen von Preisinformationen", "Recupero delle informazioni sui prezzi", "ii_prices"),
    II_PRICES_ANSWER("Génération de la réponse", "Antwortgenerierung", "Generazione della risposta", "ii_prices_answer"),
