...
public class IIAdvisor implements StreamAroundAdvisor {
    ...
    private static final String ROUTING_PROMPT = """
            ...
            Pour déterminer l'étape à exécuter, tu dois analyser les informations dans l'historique de conversation.
    ...
    private static final String CONVERT_TO_QA = """
            ...
            Exemple 1:
             message: "
                        ...
                        USER: Oui
                    "
             response:  S'agit-il d'une révision sur demande ou d'une révision d'office? Oui,
                        ...,
            ...
            Exemple 3:
             message: "
                    ...
                    "
             response:  S'agit-il d'une révision sur demande ou d'une révision d'office? Non,
